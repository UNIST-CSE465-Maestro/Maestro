...
interface SettingsRepository {
    ...
    // Quiz generation language: "ko" or "en". Defaults to "ko".
    fun getQuizLanguage(): Flow<String>
    ...
    // Question Encoder (MobileKT QE) server URL
    fun getQeServerUrl(): Flow<String?>

    suspend fun setQeServerUrl(url: String)
