...
interface AnnotationRepository {
    ...
    suspend fun saveStrokes(documentId: String, pageIndex: Int, strokes: List<InkStroke>, refWidth: Float)
    suspend fun loadImageOverlays(documentId: String, pageIndex: Int): List<ImageOverlayData>
    suspend fun saveImageOverlays(documentId: String, pageIndex: Int, overlays: List<ImageOverlayData>)
